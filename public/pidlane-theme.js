...
function closeTopOverlay(){
  ...
  if(typeof caravanActive!=='undefined' && document.getElementById('caravanDash')?.style.display!=='none' && document.getElementById('caravanDash')){ if(caravanActive){ minimizeCaravanDash(); } e[...]
